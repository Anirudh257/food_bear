...
function toggleBtnSort() {
  document.getElementById("myDropdownBtn").classList.toggle("show");
}
...
function myFunction1() {
  ...
  // for(int i=1;i<=9;i++){
  // 	document.getElementById('myDropdown'+i).classList.toggle
  // }
}
...
// iOS Inspired To Do List
//
// Ryan Pilbrow
// (https://www.ryanapilbrow.co.uk)
// <@d14rap>
...
$("form").submit(function(event) {
	...
	var newItem = $("input#new").val();
	$("input#new").val("");
	$("ul#list").prepend("<li><input type='checkbox' class='status'> " + newItem + "<button class='delete'><i class='fa fa-times'></i></button></li>");
});
